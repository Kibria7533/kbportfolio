        ...
        <footer className="site-footer">
              ...
              <div className="footer-info">
                ...
                <div className="footer-info__right">
                  ...
                  <div className="social-icons">
                    <a
                      href="https://twitter.com/ominuteversity"
                      target="_blank"
                    >
                      <img
                    ...
                    <a
                      href="https://www.pinterest.es/tenminuteversity/boards/"
                      target="_blank"
                    >
                      <img
                    ...
                    <a
                      href="https://www.youtube.com/channel/UCKpbhNRh9pp1UHFAHsGcunQ?view_as=subscriber"
                      target="_blank"
                    >
                      <img
          ...
          <div className="footer-bottom">
            <div className="site-container footer-bottom-inner">
              <p>
                © 2020 Kibria | Design by Md Golam Kibria | All rights Reserved.
              </p>
            </div>
          </div>
        </footer>
